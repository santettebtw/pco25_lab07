...
class PcoSalon : public Salon, public PcoHoareMonitor
#else
...
protected:
	...
	std::vector<std::pair<unsigned,PcoConditionVariable *>> _clients; // list of client ids, -1 if empty
